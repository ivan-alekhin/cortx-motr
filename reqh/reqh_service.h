...
#ifndef __MOTR_REQH_REQH_SERVICE_H__
...
/**
   ...
   A motr service is described to a request handler using a struct
...
/**
   ...
   Multiple services in a motr address space share the same request handler.
...
struct m0_reqh_service_type_ops {
	/**
	   ...
	   This is typically invoked during motr setup, but also can be
...
#endif /* __MOTR_REQH_REQH_SERVICE_H__ */
